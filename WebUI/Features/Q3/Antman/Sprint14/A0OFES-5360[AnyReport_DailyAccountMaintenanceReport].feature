Feature: A0OFES-5360[AnyReport_DailyAccountMaintenanceReport]

	@AnyReport_ShowFile_AdditionalInfoByOwningBranch
	Scenario: As a CS i want to show file daily account maintenance - additional info by owning branch report
	#TC_Login_CS
	...
	And I verify element "userId" present by ID
	#TC_showFile_dailyAccountMaintenanceReport_additionalInfoByOwningBranch
	...
	And I enter "Daily Account Maintenance Report" in ".select2-search__field" by css selector
	And I submit ".select2-search__field" by css selector
	And I set delay 1 seconds
	And I click "select2-selectTransactionType-container" by ID
	And I enter "Additional Info By Owning Branch" in ".select2-search__field" by css selector
	And I submit ".select2-search__field" by css selector
	...
	@AnyReport_Download_AdditionalInfoByOwningBranch
	Scenario: As a CS i want to download file daily account maintenance - additional info by owning branch report
	#TC_Login_CS
	Given I open SIT FES website "https://fes-sit.apps.ms.dev.corp.btpn.co.id" with "firefox"
	When I wait for element "userID" visible by ID
	And I verify element "userID" present by ID
	...
	And I wait for element "userId" visible by ID
	And I verify element "userId" present by ID
	#TC_download_dailyAccountMaintenanceReport_additionalInfoByOwningBranch
	And I verify element "#ANYREPRT" present by css selector
	And I scroll into element "#ANYREPRT" by css selector
	And I set delay 1 seconds
	And I click "ANYREPRT" by ID
	...
	@AnyReport_ShowFile_AdditionalInfoByTransactionBranch
	Scenario: As a CS i want to show file daily account maintenance - additional info by transaction branch report
	#TC_Login_CS
	Given I open SIT FES website "https://fes-sit.apps.ms.dev.corp.btpn.co.id" with "firefox"
	When I wait for element "userID" visible by ID
	And I verify element "userID" present by ID
	...
	And I wait for element "userId" visible by ID
	And I verify element "userId" present by ID
	#TC_showFile_dailyAccountMaintenanceReport_additionalInfoByTransactionBranch
	And I verify element "#ANYREPRT" present by css selector
	And I scroll into element "#ANYREPRT" by css selector
	And I set delay 1 seconds
	And I click "ANYREPRT" by ID
	...
	And I set delay 1 seconds
	And I click "select2-selectTransactionType-container" by ID
	And I enter "Additional Info By Transaction Branch" in ".select2-search__field" by css selector
	And I submit ".select2-search__field" by css selector
	And I clear text "startDate" by ID
	And I enter "01/08/2020" in "startDate" by ID
	And I set delay 1 seconds
	...
	@AnyReport_Download_AdditionalInfoByTransactionBranch
	Scenario: As a CS i want to download file daily account maintenance - additional info by transaction branch report
	#TC_Login_CS
	Given I open SIT FES website "https://fes-sit.apps.ms.dev.corp.btpn.co.id" with "firefox"
	When I wait for element "userID" visible by ID
	And I verify element "userID" present by ID
	...
	And I wait for element "userId" visible by ID
	And I verify element "userId" present by ID
	#TC_download_dailyAccountMaintenanceReport_additionalInfoByTransactionBranch
	And I verify element "#ANYREPRT" present by css selector
	And I scroll into element "#ANYREPRT" by css selector
	And I set delay 1 seconds
	And I click "ANYREPRT" by ID
