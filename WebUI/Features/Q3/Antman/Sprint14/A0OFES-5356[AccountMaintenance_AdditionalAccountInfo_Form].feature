Feature: A0OFES-5356[AccountMaintenance_AdditionalAccountInfo_Form]

	@AccountMaintenance_DHESDA_NO_Form
	Scenario: As a CS i want to print form update DHE SDA status 'NO' on Account Maintenance Menu
	#TC_Login_CS
	...
	@AccountMaintenance_DHESDA_YES_Form
	Scenario: As a CS i want to print form update DHE SDA status 'YES' on Account Maintenance Menu
	#TC_Login_CS
	Given I open SIT FES website "https://fes-sit.apps.ms.dev.corp.btpn.co.id" with "firefox"
	When I wait for element "userID" visible by ID
	And I verify element "userID" present by ID
