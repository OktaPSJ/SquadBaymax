Feature: A0OFES-5530[AnyReport_DailyOpeningTDReport]

	@AnyReport_ShowFile_All_DailyOpeningTDReport
	Scenario: As a CS i want to show file all currency daily opening TD report
	#TC_Login_CS
	...
	And I take screenshot "result/A0OFES-5530[AnyReport_DailyOpeningTDReport]/001-login.png"
	And I click "btnLogin" by ID
	And I wait for element "userId" visible by ID
	And I verify element "userId" present by ID
	#TC_showFile_all_dailyOpeningTDReport
	...
	And I take screenshot "result/A0OFES-5530[AnyReport_DailyOpeningTDReport]/002-select_menu.png"
	...
	And I enter "Daily Opening TD Report" in ".select2-search__field" by css selector
	...
	And I click "fcCurrencyAll" by ID	
	And I set delay 1 seconds
	And I take screenshot "result/A0OFES-5530[AnyReport_DailyOpeningTDReport]/003-ready_for_process.png"
	...
	And I take screenshot "result/A0OFES-5530[AnyReport_DailyOpeningTDReport]/004-generate_report.png"
	...
	And I set delay 1 seconds
	And I take screenshot "result/A0OFES-5530[AnyReport_DailyOpeningTDReport]/005-print_report.png"
	...
	@AnyReport_Download_All_DailyOpeningTDReport
	Scenario: As a CS i want to download file all currency daily opening TD report
	#TC_Login_CS
	Given I open SIT FES website "https://fes-sit.apps.ms.dev.corp.btpn.co.id" with "firefox"
	When I wait for element "userID" visible by ID
	And I verify element "userID" present by ID
	...
	And I wait for element "userId" visible by ID
	And I verify element "userId" present by ID
	#TC_download_all_dailyOpeningTDReport
	And I verify element "#ANYREPRT" present by css selector
	And I scroll into element "#ANYREPRT" by css selector
	And I set delay 1 seconds
	And I click "ANYREPRT" by ID
